...
type RedeemEyesRequest struct {
	Email       string `json:"email"`
	PrivateKeyD string `json:"privateKey"`
	Eyes        string `json:"eyes"`
}

func RedeemEyesRoute(w http.ResponseWriter, r *http.Request, blockchainInstance *blockchain.Blockchain) {
	var request RedeemEyesRequest
